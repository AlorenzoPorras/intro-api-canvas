...
const canvasBeizer = document.getElementById("canvasBeizer");
const canvasBeizerC = document.getElementById("canvasBeizerC");
const canvascombi = document.getElementById("canvascombi");

function drawrRectangulo() {
